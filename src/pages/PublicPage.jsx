...
const PublicPage = () => {
  ...
  if (!userData) return <div className="text-center mt-5"><h1>404 - No encontrado</h1></div>;
  ...
  return (
    <div className={styles.publicPageWrapper} style={dynamicWrapper}>
      ...
      {theme?.backgroundImage && (
        <div className={styles.overlay} style={{ backgroundColor: "rgba(0,0,0,0.3)" }} />
      )}

      <div className={styles.glassCard} style={{ color: theme?.textColor || "#000" }}>
        <Image
        ...
        <p className="mb-4 fw-medium" style={{ opacity: 0.9 }}>{profile?.bio}</p>
        ...
        <div className={styles.socialIcons}>
          {socials?.instagram && (
            <a href={socials.instagram} target="_blank" rel="noreferrer" style={{ color: theme?.textColor }}>
              <FaInstagram />
            </a>
          )}
          {socials?.github && (
            <a href={socials.github} target="_blank" rel="noreferrer" style={{ color: theme?.textColor }}>
              <FaGithub />
            </a>
          )}
          {socials?.twitter && (
            <a href={socials.twitter} target="_blank" rel="noreferrer" style={{ color: theme?.textColor }}>
              <FaTwitter />
            </a>
          )}
        </div>
