...
const Dashboard = () => {
  ...
  const copyToClipboard = () => {
    ...
    Swal.fire({
      icon: "info",
      title: "URL Copiada",
      text: "Pégala en tu bio de Instagram",
      timer: 2000,
    });
  };
                ...
                <div className="mb-4">
                  ...
                  <Form.Group className="mb-2">
                    <InputGroup>
                      ...
                      <Form.Control
                        placeholder="Pega tu link de Instagram aquí"
                        value={settings.socials?.instagram || ""} // Evita errores si es undefined
                        onChange={(e) => {
                          const val = e.target.value;
                          setSettings((prev) => ({
                            ...prev,
                            socials: { ...prev.socials, instagram: val },
                          }));
                        }}
                      />
                    </InputGroup>
                  ...
                  <Form.Group className="mb-2">
                    <InputGroup>
                      ...
                      <Form.Control
                        placeholder="Pega tu link de GitHub aquí"
