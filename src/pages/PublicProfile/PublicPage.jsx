...
import { Spinner, Image, Button, Container } from "react-bootstrap";
...
const PublicPage = () => {
  ...
  if (loading) return (
    <div className={styles.loaderWrapper}>
      ...
      <p className="mt-3 text-white">Buscando al lince...</p>
    </div>
  );
  ...
  if (!userData) return (
    <div className={styles.errorWrapper}>
      <h1>404</h1>
      <p>No se encontró el rastro del lince.</p>
      <Button href="/" variant="primary" className="rounded-pill px-4">Volver al inicio</Button>
    </div>
  );
  ...
  return (
    ...
    >
            ...
            {links.map((link) => (
              <Button
                ...
                style={{
                  ...
                  /* Efecto de brillo sutil para que parezcan botones premium */
      ...
      {/* 🔒 FOOTER DE AUTORÍA 🔒 */}
      {/* Lo envolvemos en un div para darle un estilo sutil que no compita con el perfil */}
